        ...
        if (modal.event !== '') {
            ...
            if (modal.mode === 'add') {
                ...
                setEvents((prevEvents) => [
                    ...
                    {
                        id: Date.now(),
                        title: modal.event.title.modal.event.title.charAt(0).toUpperCase() + modal.event.title.slice(1),
                        start,
                        end,
                    },
                ]);
                                        ...
                                        <div className="mb-3">
                                            ...
                                            <input
                                                ...
                                                disabled={
                                                    ...
                                                    new Date(modal.event.startDate) < new Date(new Date().toISOString().split('T')[0])
                                                }
                                                // min={modal.event.startDate || new Date().toISOString().split('T')[0]}
                                                onChange={(e) =>
                                            ...
                                            //     // Validate input to ensure no past dates can be typed
                                            //     if (selectedDate >= today) {
                                            //         setModal({ ...modal, event: { ...modal.event, startDate: selectedDate } });
                                            //     } else {
                                            //         alert("You cannot select or type a past date."); // Optional feedback
                                            //     }
                                            // }}
                                            />
                                        </div>
                                    ...
                                    <div className="col-12 col-md-6">
                                        ...
                                        <div className="mb-3">
                                            ...
                                            <input
                                                ...
                                                min={modal.event.endDate || new Date().toISOString().split('T')[0]}
                                                onChange={(e) =>
