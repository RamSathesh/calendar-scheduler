                                ...
                                <div className="row">
                                    <div className="col-12 col-md-6">
                                        <div className="mb-3">
                                            ...
                                            <DatePicker
                                                selected={new Date(modal.event.startDate)}
                                                onChange={(date) =>
                                                    setModal({ ...modal, event: { ...modal.event, startDate: date.toISOString().split('T')[1] } })
                                                }
                                                minDate={new Date()}
                                                className="form-control"
                                ...
                                <div className="row">
                                    <div className="col-12 col-md-6">
                                        <div className="mb-3">
                                            ...
                                            <DatePicker
                                                selected={new Date(modal.event.endDate)}
                                                onChange={(date) =>
                                                    setModal({ ...modal, event: { ...modal.event, endDate: date.toISOString().split('T')[1] } })
                                                }
